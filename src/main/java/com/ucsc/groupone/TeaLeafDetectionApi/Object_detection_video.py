...
MODEL_NAME = 'models/tea_leaves_graph_resnet101'
VIDEO_NAME = 'test_video/tea-new.m4v'
...
out = cv2.VideoWriter('tea-new-2-classified.avi', cv2.VideoWriter_fourcc('M', 'J', 'P', 'G'), 10, (int(video.get(3)), int(video.get(4))))
